Moves.JapesCoconut = new Moves("Japes Coconut Gates", true, [[Moves.ClimbingCheck, Moves.JapesFreeKong], [Moves.AllWarps, Moves.JapesFreeKong]], true);
Moves.AztecTunnelDoor = new Moves("Aztec Tunnel Door", true, [[Moves.Vines, Moves.ClimbingCheck, Moves.AztecGuitar], [Moves.ClimbingCheck, Moves.Rocket, Moves.AztecGuitar]], true);
Moves.Aztec5DT = new Moves("Aztec 5DT Switches", true, [[Moves.LevelSlam, Moves.Peanut, Moves.Rocket, Moves.AllWarps], [Moves.LevelSlam, Moves.Peanut, Moves.Rocket, Moves.AztecTunnelDoor]], true);
Moves.AztecLlama = new Moves("Aztec Llama Switch", true, [[Moves.Blast, Moves.AllWarps], [Moves.Blast, Moves.AztecTunnelDoor]], true);
